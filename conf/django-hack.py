...
sys.path[0:0] = [
    ...
    join(base, "eggs/psutil-3.3.0-py2.7-linux-aarch64.egg"),
    join(base, "eggs/psycogreen-1.0-py2.7.egg"),
    join(base, "eggs/psycopg2-2.8.7-py2.7-linux-x86_64.egg"),
    join(base, "eggs/psycopg2-2.8.7-py2.7-linux-aarch64.egg"),
    ...
    join(base, "eggs/pyzmq-15.0.0-py2.7-linux-aarch64.egg"),
