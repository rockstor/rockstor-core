...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Snapshot.rusage'
        db.add_column(u'storageadmin_snapshot', 'rusage',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Snapshot.eusage'
        db.add_column(u'storageadmin_snapshot', 'eusage',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Share.rusage'
        db.add_column(u'storageadmin_share', 'rusage',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Share.eusage'
        db.add_column(u'storageadmin_share', 'eusage',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Snapshot.rusage'
        db.delete_column(u'storageadmin_snapshot', 'rusage')

        # Deleting field 'Snapshot.eusage'
        db.delete_column(u'storageadmin_snapshot', 'eusage')

        # Deleting field 'Share.rusage'
        db.delete_column(u'storageadmin_share', 'rusage')

        # Deleting field 'Share.eusage'
        db.delete_column(u'storageadmin_share', 'eusage')
    ...
    models = {
        ...
        u'oauth2_provider.application': {
            ...
            'client_id': ('django.db.models.fields.CharField', [], {'default': "u'EPmKQvrI6gfxbepsBrgfazd_Mpsl6wEMBro_ITJ3'", 'unique': 'True', 'max_length': '100'}),
            'client_secret': ('django.db.models.fields.CharField', [], {'default': "u'R0!beB6wjCDJwvKd?kYq?!@34FQlPa1S_Pf3=7f2b2WQyCe-8NIRP0EJmdN8A_6zqf_ze@Yiz6HCFUVQT!sZcfo!L!E69vLk=IiiHZ_f317:b7kWZu17VKzreOi40-58'", 'max_length': '255', 'blank': 'True'}),
