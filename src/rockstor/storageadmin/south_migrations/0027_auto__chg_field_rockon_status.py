...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RockOn.status'
        db.alter_column(u'storageadmin_rockon', 'status', self.gf('django.db.models.fields.CharField')(max_length=2048))

    def backwards(self, orm):

        # Changing field 'RockOn.status'
        db.alter_column(u'storageadmin_rockon', 'status', self.gf('django.db.models.fields.CharField')(max_length=32))
    ...
    models = {
        ...
        u'oauth2_provider.application': {
            ...
            'client_id': ('django.db.models.fields.CharField', [], {'default': "u'ng@yHlB-sqHL351UT-epUuTpFY3ZHKqDXU3UO4kL'", 'unique': 'True', 'max_length': '100'}),
            'client_secret': ('django.db.models.fields.CharField', [], {'default': "u'vn?kPgslowwW-n?Vlfm2nrzB24keNU-vA53o?ri!!-HqdxX-9ZaJ-D2Md-w:Xr:1:UI4Za6fAuf0Dyi7;V3;ec_Wbb03OtiCdfYUqFq:u?daCrZIcFuU8@jTOqjFYat:'", 'max_length': '255', 'blank': 'True'}),
