...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Pool.compression'
        db.add_column(u'storageadmin_pool', 'compression',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True),
                      keep_default=False)

        # Adding field 'Pool.mnt_options'
        db.add_column(u'storageadmin_pool', 'mnt_options',
                      self.gf('django.db.models.fields.CharField')(max_length=4096, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Pool.compression'
        db.delete_column(u'storageadmin_pool', 'compression')

        # Deleting field 'Pool.mnt_options'
        db.delete_column(u'storageadmin_pool', 'mnt_options')
    ...
    models = {
        ...
        u'oauth2_provider.application': {
            ...
            'client_id': ('django.db.models.fields.CharField', [], {'default': "u'FBg4UH@I@D;1V;DllbqhMwh?!;CQa8YSb-1gNvAe'", 'unique': 'True', 'max_length': '100'}),
            'client_secret': ('django.db.models.fields.CharField', [], {'default': "u'o541Xadkwvxseh8M=Ii@p2hxuIFSWoGYI6h7gbh?7;O26sVoPEzxVaxkyV8I4GF-8eopf2laq;DlMfuwlqWpPC6=5F:_K7XT;:.fpDa!1G;ous=8=:BIaXzoxzq?;i?F'", 'max_length': '255', 'blank': 'True'}),
