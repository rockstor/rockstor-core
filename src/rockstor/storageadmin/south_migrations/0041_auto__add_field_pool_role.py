...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'storageadmin_pool', 'role',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'storageadmin_pool', 'role')
    ...
    models = {
        ...
        u'oauth2_provider.application': {
            ...
            'client_id': ('django.db.models.fields.CharField', [], {'default': "u'7vT8FiFr1lMh32VKmy66U3CQhfIfm117EmHAnDS0'", 'unique': 'True', 'max_length': '100', 'db_index': 'True'}),
            'client_secret': ('django.db.models.fields.CharField', [], {'default': "u'xLf4QgHgJl9WoD9lCQYq9HDwe3COHsgY8vDZoqPOGHQTseRJ9WSlrEbapg9ew867j9K2HUBkfxbYkzru2GL81YDGo1VCS6J3p8lwJRsdF4TSGySIiUBkD8IeSVch37LN'", 'max_length': '255', 'db_index': 'True', 'blank': 'True'}),
