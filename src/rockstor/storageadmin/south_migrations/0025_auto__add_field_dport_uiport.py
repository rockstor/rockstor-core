...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DPort.uiport'
        db.add_column(u'storageadmin_dport', 'uiport',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DPort.uiport'
        db.delete_column(u'storageadmin_dport', 'uiport')
    ...
    models = {
        ...
        u'oauth2_provider.application': {
            ...
            'client_id': ('django.db.models.fields.CharField', [], {'default': "u'j5i_5GcebRAJ0?uC59mlrsv=aX1TCOnJnki-.SQF'", 'unique': 'True', 'max_length': '100'}),
            'client_secret': ('django.db.models.fields.CharField', [], {'default': "u'a9tGhAj_y=FH?YjwCInk:ijdb5s=-JHWw7!!=Lh6=zGpZslcYAQ=3?!__loo7!Mdg.r?RiS:GZ0o2-R4Sru!_Qc_OiV!k!;BgHR5d_rn-LEXx0eK32T=u6cpdw;@DJat'", 'max_length': '255', 'blank': 'True'}),
