...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Share.pqgroup'
        db.add_column(u'storageadmin_share', 'pqgroup',
                      self.gf('django.db.models.fields.CharField')(default='-1/-1', max_length=32),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Share.pqgroup'
        db.delete_column(u'storageadmin_share', 'pqgroup')
    ...
    models = {
        ...
        u'oauth2_provider.application': {
            ...
            'client_id': ('django.db.models.fields.CharField', [], {'default': "u'-zL8j?Ko?Mj!gy97rYZ0sQAc1MqgSv.2CQctr=gK'", 'unique': 'True', 'max_length': '100'}),
            'client_secret': ('django.db.models.fields.CharField', [], {'default': "u'Dhc?77BZW4BF@siAT_c7!Xe;G4ocjasO@57D-D6husPWRzkQnOP;QbgWuaV??ji?2PJml?7U9q;;WckIxwZhjSr9v!Lfx8R4K:0J6p7mjShvE?gn3u.g83z.b6EGwE0r'", 'max_length': '255', 'blank': 'True'}),
