...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UpdateSubscription'
        db.create_table(u'storageadmin_updatesubscription', (
            ...
            ('appliance', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['storageadmin.Appliance'])),
            ('password', self.gf('django.db.models.fields.CharField')(max_length=64, null=True)),
            ('status', self.gf('django.db.models.fields.CharField')(max_length=64)),
        ))
        db.send_create_signal('storageadmin', ['UpdateSubscription'])


    def backwards(self, orm):
        # Deleting model 'UpdateSubscription'
        db.delete_table(u'storageadmin_updatesubscription')
    ...
    models = {
        ...
        u'oauth2_provider.application': {
            ...
            'client_id': ('django.db.models.fields.CharField', [], {'default': "u'8Igk89q9IEM8Wav!3?b9KVcnF1mokFQbJ_RM;K?j'", 'unique': 'True', 'max_length': '100'}),
            'client_secret': ('django.db.models.fields.CharField', [], {'default': "u'8AW0Zawdy@-wK6Z?Z6XbGV.=fXnUhjB;?1BE?rYkPb?gqqWkdm:3E?5;gijAk@C6051GRd1Pp8BHzuTwy3CS.OsFng_IL5;.HJ@fJgt3cWkqmL-_a:MPQHLVl7e7:XvJ'", 'max_length': '255', 'blank': 'True'}),
