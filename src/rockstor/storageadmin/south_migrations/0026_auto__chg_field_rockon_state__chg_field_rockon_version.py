...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RockOn.state'
        db.alter_column(u'storageadmin_rockon', 'state', self.gf('django.db.models.fields.CharField')(max_length=2048))

        # Changing field 'RockOn.version'
        db.alter_column(u'storageadmin_rockon', 'version', self.gf('django.db.models.fields.CharField')(max_length=2048))

    def backwards(self, orm):

        # Changing field 'RockOn.state'
        db.alter_column(u'storageadmin_rockon', 'state', self.gf('django.db.models.fields.CharField')(max_length=32))

        # Changing field 'RockOn.version'
        db.alter_column(u'storageadmin_rockon', 'version', self.gf('django.db.models.fields.CharField')(max_length=32))
    ...
    models = {
        ...
        u'oauth2_provider.application': {
            ...
            'client_id': ('django.db.models.fields.CharField', [], {'default': "u'dQn0=8U5Ri7Mx_OJbj4z_vDN2dbxT9K9@v.JV!05'", 'unique': 'True', 'max_length': '100'}),
            'client_secret': ('django.db.models.fields.CharField', [], {'default': "u'@sXnA.4QKslJtJKDxp6CLtvrXA!!L1yUacPdw1s1Yx7G?6yvHNv!-mD4R=QVfWQmR8zSnFeqY;;ztG5dkCjpFsoo=;3r0vqebaKaUkbggJgNnFdBb@mUA9u49;XzD1pY'", 'max_length': '255', 'blank': 'True'}),
