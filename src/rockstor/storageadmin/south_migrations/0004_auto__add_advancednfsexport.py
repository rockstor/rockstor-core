...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AdvancedNFSExport'
        db.create_table(u'storageadmin_advancednfsexport', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('export_str', self.gf('django.db.models.fields.CharField')(max_length=4096)),
        ))
        db.send_create_signal('storageadmin', ['AdvancedNFSExport'])


    def backwards(self, orm):
        # Deleting model 'AdvancedNFSExport'
        db.delete_table(u'storageadmin_advancednfsexport')
