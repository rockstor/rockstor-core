...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'NetworkInterface.domain'
        db.delete_column(u'storageadmin_networkinterface', 'domain')

        # Deleting field 'NetworkInterface.boot_proto'
        db.delete_column(u'storageadmin_networkinterface', 'boot_proto')

        # Deleting field 'NetworkInterface.network'
        db.delete_column(u'storageadmin_networkinterface', 'network')

        # Deleting field 'NetworkInterface.alias'
        db.delete_column(u'storageadmin_networkinterface', 'alias')

        # Deleting field 'NetworkInterface.onboot'
        db.delete_column(u'storageadmin_networkinterface', 'onboot')

        # Adding field 'NetworkInterface.dname'
        db.add_column(u'storageadmin_networkinterface', 'dname',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True),
                      keep_default=False)

        # Adding field 'NetworkInterface.dtype'
        db.add_column(u'storageadmin_networkinterface', 'dtype',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True),
                      keep_default=False)

        # Adding field 'NetworkInterface.dspeed'
        db.add_column(u'storageadmin_networkinterface', 'dspeed',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True),
                      keep_default=False)

        # Adding field 'NetworkInterface.method'
        db.add_column(u'storageadmin_networkinterface', 'method',
                      self.gf('django.db.models.fields.CharField')(default='auto', max_length=64),
                      keep_default=False)

        # Adding field 'NetworkInterface.autoconnect'
        db.add_column(u'storageadmin_networkinterface', 'autoconnect',
                      self.gf('django.db.models.fields.CharField')(default='yes', max_length=8),
                      keep_default=False)

        # Adding field 'NetworkInterface.ctype'
        db.add_column(u'storageadmin_networkinterface', 'ctype',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True),
                      keep_default=False)

        # Adding field 'NetworkInterface.state'
        db.add_column(u'storageadmin_networkinterface', 'state',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True),
                      keep_default=False)
        ...
        # Changing field 'NetworkInterface.ipaddr'
        db.alter_column(u'storageadmin_networkinterface', 'ipaddr', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

        # Changing field 'NetworkInterface.netmask'
        db.alter_column(u'storageadmin_networkinterface', 'netmask', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

        # Changing field 'NetworkInterface.gateway'
        db.alter_column(u'storageadmin_networkinterface', 'gateway', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

        # Changing field 'NetworkInterface.mac'
        db.alter_column(u'storageadmin_networkinterface', 'mac', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Disk.name'
        db.alter_column(u'storageadmin_disk', 'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=64))

    def backwards(self, orm):
        # Removing unique constraint on 'NetworkInterface', fields ['name']
        db.delete_unique(u'storageadmin_networkinterface', ['name'])

        # Adding field 'NetworkInterface.domain'
        db.add_column(u'storageadmin_networkinterface', 'domain',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True),
                      keep_default=False)

        # Adding field 'NetworkInterface.boot_proto'
        db.add_column(u'storageadmin_networkinterface', 'boot_proto',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True),
                      keep_default=False)

        # Adding field 'NetworkInterface.network'
        db.add_column(u'storageadmin_networkinterface', 'network',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True),
                      keep_default=False)

        # Adding field 'NetworkInterface.alias'
        db.add_column(u'storageadmin_networkinterface', 'alias',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True),
                      keep_default=False)

        # Adding field 'NetworkInterface.onboot'
        db.add_column(u'storageadmin_networkinterface', 'onboot',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True),
                      keep_default=False)

        # Deleting field 'NetworkInterface.dname'
        db.delete_column(u'storageadmin_networkinterface', 'dname')

        # Deleting field 'NetworkInterface.dtype'
        db.delete_column(u'storageadmin_networkinterface', 'dtype')

        # Deleting field 'NetworkInterface.dspeed'
        db.delete_column(u'storageadmin_networkinterface', 'dspeed')

        # Deleting field 'NetworkInterface.method'
        db.delete_column(u'storageadmin_networkinterface', 'method')

        # Deleting field 'NetworkInterface.autoconnect'
        db.delete_column(u'storageadmin_networkinterface', 'autoconnect')

        # Deleting field 'NetworkInterface.ctype'
        db.delete_column(u'storageadmin_networkinterface', 'ctype')

        # Deleting field 'NetworkInterface.state'
        db.delete_column(u'storageadmin_networkinterface', 'state')


        # Changing field 'NetworkInterface.ipaddr'
        db.alter_column(u'storageadmin_networkinterface', 'ipaddr', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'NetworkInterface.netmask'
        db.alter_column(u'storageadmin_networkinterface', 'netmask', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'NetworkInterface.gateway'
        db.alter_column(u'storageadmin_networkinterface', 'gateway', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'NetworkInterface.mac'
        db.alter_column(u'storageadmin_networkinterface', 'mac', self.gf('django.db.models.fields.CharField')(default='n/a', max_length=100))

        # Changing field 'Disk.name'
        db.alter_column(u'storageadmin_disk', 'name', self.gf('django.db.models.fields.CharField')(max_length=10, unique=True))
    ...
    models = {
        ...
        u'oauth2_provider.application': {
            ...
            'client_id': ('django.db.models.fields.CharField', [], {'default': "u'Cq?8=0wZ76qDfE8kccQH=_c1CUpkwpKyCRi5MLxB'", 'unique': 'True', 'max_length': '100'}),
            'client_secret': ('django.db.models.fields.CharField', [], {'default': "u'BY6URJlS;2aD.VBm-C8!rg@33uNhHojHuFTqJrWE062mgJS!h_yhmovG2c_1LzFtLSS9dGiKFvxXygPGj7DvJ7g78HzW7IUhjV1GaM4l034sp0=4TBTTT:_BHEk=-?BO'", 'max_length': '255', 'blank': 'True'}),
        ...
        'storageadmin.networkinterface': {
            ...
            'autoconnect': ('django.db.models.fields.CharField', [], {'default': "'yes'", 'max_length': '8'}),
            ...
            'method': ('django.db.models.fields.CharField', [], {'default': "'auto'", 'max_length': '64'}),
