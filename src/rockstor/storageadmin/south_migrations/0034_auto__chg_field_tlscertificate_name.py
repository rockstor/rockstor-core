...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'storageadmin_tlscertificate', 'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=12288))

    def backwards(self, orm):

        # Changing field 'TLSCertificate.name'
        db.alter_column(u'storageadmin_tlscertificate', 'name', self.gf('django.db.models.fields.CharField')(max_length=1024, unique=True))
    ...
    models = {
        ...
        u'oauth2_provider.application': {
            ...
            'client_id': ('django.db.models.fields.CharField', [], {'default': "u'pow!@pgO3;ISGswv9sUa6Btz2UV_HhwW14IKNUBe'", 'unique': 'True', 'max_length': '100'}),
            'client_secret': ('django.db.models.fields.CharField', [], {'default': "u'CxbnqamAu2!=L!-pKnT74f!=lCFYzgBWOx5=!5AuCA7Ls:HMPSc;o86tC.Oo:LzNwRwFjMc6p!n4JWbAz:N2shHwhax5W6SMONFNf5YWwJMdE@i6F-zkH@4nM2RWONd.'", 'max_length': '255', 'blank': 'True'}),
