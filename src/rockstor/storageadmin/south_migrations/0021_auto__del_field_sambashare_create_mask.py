...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SambaShare.create_mask'
        db.delete_column(u'storageadmin_sambashare', 'create_mask')


    def backwards(self, orm):
        # Adding field 'SambaShare.create_mask'
        db.add_column(u'storageadmin_sambashare', 'create_mask',
                      self.gf('django.db.models.fields.CharField')(default='0755', max_length=4),
                      keep_default=False)
    ...
    models = {
        ...
        u'oauth2_provider.application': {
            ...
            'client_id': ('django.db.models.fields.CharField', [], {'default': "u'H3@SQ_2AfUItH7Fl!IwoTMFVmU6!I1p57IjgqD4P'", 'unique': 'True', 'max_length': '100'}),
            'client_secret': ('django.db.models.fields.CharField', [], {'default': "u'CW!CalTzqr=20ymz8JpOUEgJiE:G.qRb;MovFsoNxDMgWLlw!Um9!UC1Sv!7JBd9-RqRZgoxL3S4@qw3T!Y2e4@sfM;E!rPK::6GlTc6OC@Od3-IHMTj:OzGHhk8rD9I'", 'max_length': '255', 'blank': 'True'}),
