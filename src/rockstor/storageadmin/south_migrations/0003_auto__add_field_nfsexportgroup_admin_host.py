...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NFSExportGroup.admin_host'
        db.add_column(u'storageadmin_nfsexportgroup', 'admin_host',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NFSExportGroup.admin_host'
        db.delete_column(u'storageadmin_nfsexportgroup', 'admin_host')
