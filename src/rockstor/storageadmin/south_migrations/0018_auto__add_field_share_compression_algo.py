...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Share.compression_algo'
        db.add_column(u'storageadmin_share', 'compression_algo',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Share.compression_algo'
        db.delete_column(u'storageadmin_share', 'compression_algo')
    ...
    models = {
        ...
        u'oauth2_provider.application': {
            ...
            'client_id': ('django.db.models.fields.CharField', [], {'default': "u'dZOoJ7OUq5sNLIZB?MxjrtSyudI?cW1mycnhhXd8'", 'unique': 'True', 'max_length': '100'}),
            'client_secret': ('django.db.models.fields.CharField', [], {'default': "u'zsx;2:-EQi06dYX3cPEV;0AWR=5CQdjhk_Y8lamDFN0W1yRUTG4n:2pKQ0G@Sty9TB1c-kkjG2FX;X213WASnJ?!anhaS@fX.wzMKHjBdTwMR8u6gxKVpBndW?2AHhAL'", 'max_length': '255', 'blank': 'True'}),
