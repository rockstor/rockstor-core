...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TLSCertificate.certificate'
        db.alter_column(u'storageadmin_tlscertificate', 'certificate', self.gf('django.db.models.fields.CharField')(max_length=12288, null=True))

        # Changing field 'TLSCertificate.key'
        db.alter_column(u'storageadmin_tlscertificate', 'key', self.gf('django.db.models.fields.CharField')(max_length=12288, null=True))

        # Changing field 'TLSCertificate.name'
        db.alter_column(u'storageadmin_tlscertificate', 'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=1024))

    def backwards(self, orm):

        # Changing field 'TLSCertificate.certificate'
        db.alter_column(u'storageadmin_tlscertificate', 'certificate', self.gf('django.db.models.fields.CharField')(max_length=2048, null=True))

        # Changing field 'TLSCertificate.key'
        db.alter_column(u'storageadmin_tlscertificate', 'key', self.gf('django.db.models.fields.CharField')(max_length=2048, null=True))

        # Changing field 'TLSCertificate.name'
        db.alter_column(u'storageadmin_tlscertificate', 'name', self.gf('django.db.models.fields.CharField')(max_length=12288, unique=True))
    ...
    models = {
        ...
        u'oauth2_provider.application': {
            ...
            'client_id': ('django.db.models.fields.CharField', [], {'default': "u'di8cNkbcpXY5iiCypfJxbOHBBAv8fcbnrEVr4mxQ'", 'unique': 'True', 'max_length': '100', 'db_index': 'True'}),
            'client_secret': ('django.db.models.fields.CharField', [], {'default': "u'eZBwV5zDYLYOToFzo3wxwYV1wNngywakBk1DrskXXtGjzK2dav64pde9BauJtUSDr6eOKJa3v1a9nWaClICcZoamLSOwVn04EdKN06zcDNrScURKwtp61iHunThQAH9D'", 'max_length': '255', 'db_index': 'True', 'blank': 'True'}),
