...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EmailClient'
        db.create_table(u'storageadmin_emailclient', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('smtp_server', self.gf('django.db.models.fields.CharField')(max_length=1024)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=1024)),
            ('sender', self.gf('django.db.models.fields.CharField')(max_length=1024)),
            ('receiver', self.gf('django.db.models.fields.CharField')(max_length=1024)),
        ))
        db.send_create_signal('storageadmin', ['EmailClient'])


        # Changing field 'Snapshot.toc'
        db.alter_column(u'storageadmin_snapshot', 'toc', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'ConfigBackup.config_backup'
        db.alter_column(u'storageadmin_configbackup', 'config_backup', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))


    def backwards(self, orm):
        # Deleting model 'EmailClient'
        db.delete_table(u'storageadmin_emailclient')


        # Changing field 'Snapshot.toc'
        db.alter_column(u'storageadmin_snapshot', 'toc', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'ConfigBackup.config_backup'
        db.alter_column(u'storageadmin_configbackup', 'config_backup', self.gf('django.db.models.fields.files.FileField')(default='', max_length=100))
    ...
    models = {
        ...
        u'oauth2_provider.application': {
            ...
            'client_id': ('django.db.models.fields.CharField', [], {'default': "u'-@PXd8!Tzq=rV2dM@ES36ipJtwEA1r31aLUhhoCT'", 'unique': 'True', 'max_length': '100'}),
            'client_secret': ('django.db.models.fields.CharField', [], {'default': "u'aVlBKVL?JH1KSNQ5x77B8W.@7b!c-qX42=wZQc:D6MSO349K7-wa=EhDqINu:068lqg:KjOnMwb.LkkCmQv13yIHwvXU!C9nl7akgO85o?9P6OO@bEFiXfvMLVEMUC5Q'", 'max_length': '255', 'blank': 'True'}),
