...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'storageadmin_disk', 'size', self.gf('django.db.models.fields.BigIntegerField')())

        # Changing field 'Snapshot.size'
        db.alter_column(u'storageadmin_snapshot', 'size', self.gf('django.db.models.fields.BigIntegerField')())

        # Changing field 'Pool.size'
        db.alter_column(u'storageadmin_pool', 'size', self.gf('django.db.models.fields.BigIntegerField')())

        # Changing field 'PoolScrub.errors'
        db.alter_column(u'storageadmin_poolscrub', 'errors', self.gf('django.db.models.fields.BigIntegerField')(null=True))

        # Changing field 'PoolScrub.kb_scrubbed'
        db.alter_column(u'storageadmin_poolscrub', 'kb_scrubbed', self.gf('django.db.models.fields.BigIntegerField')(null=True))

        # Changing field 'Share.size'
        db.alter_column(u'storageadmin_share', 'size', self.gf('django.db.models.fields.BigIntegerField')())
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Disk.size'
        db.alter_column(u'storageadmin_disk', 'size', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Snapshot.size'
        db.alter_column(u'storageadmin_snapshot', 'size', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Pool.size'
        db.alter_column(u'storageadmin_pool', 'size', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'PoolScrub.errors'
        db.alter_column(u'storageadmin_poolscrub', 'errors', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'PoolScrub.kb_scrubbed'
        db.alter_column(u'storageadmin_poolscrub', 'kb_scrubbed', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Share.size'
        db.alter_column(u'storageadmin_share', 'size', self.gf('django.db.models.fields.IntegerField')())
