...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Snapshot.snap_type'
        db.add_column('storageadmin_snapshot', 'snap_type',
                      self.gf('django.db.models.fields.CharField')(default='admin', max_length=64),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Snapshot.snap_type'
        db.delete_column('storageadmin_snapshot', 'snap_type')
