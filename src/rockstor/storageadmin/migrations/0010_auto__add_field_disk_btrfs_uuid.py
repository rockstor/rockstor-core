...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Disk.btrfs_uuid'
        db.add_column(u'storageadmin_disk', 'btrfs_uuid',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Disk.btrfs_uuid'
        db.delete_column(u'storageadmin_disk', 'btrfs_uuid')
    ...
    models = {
        ...
        u'oauth2_provider.application': {
            ...
            'client_id': ('django.db.models.fields.CharField', [], {'default': "u'6!8i-gxGo;of.mF8jPNb_iK0Mk@0FPC1@BzY6Ycy'", 'unique': 'True', 'max_length': '100'}),
            'client_secret': ('django.db.models.fields.CharField', [], {'default': "u'p2AL0jc?Haf!rFvIeW8JMwSlZXodr_ps;1j:4aUW5=47yUcGj97PvQ9o:dBwyOcy.W.MKNZDk!FLT@Hx9gSpwi4:aBLbA=sGg8I?5yHrwNNnO9R;fKIkLA7b@Ri:m5GR'", 'max_length': '255', 'blank': 'True'}),
