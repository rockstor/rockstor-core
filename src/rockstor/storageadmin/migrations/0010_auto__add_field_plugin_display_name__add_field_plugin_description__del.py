...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Plugin', fields ['css_file_name']
        db.delete_unique('storageadmin_plugin', ['css_file_name'])

        # Removing unique constraint on 'Plugin', fields ['js_file_name']
        db.delete_unique('storageadmin_plugin', ['js_file_name'])

        # Adding field 'Plugin.display_name'
        db.add_column('storageadmin_plugin', 'display_name',
                      self.gf('django.db.models.fields.CharField')(default='', unique=True, max_length=4096),
                      keep_default=False)

        # Adding field 'Plugin.description'
        db.add_column('storageadmin_plugin', 'description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=4096),
                      keep_default=False)

        # Adding field 'InstalledPlugin.install_date'
        db.add_column('storageadmin_installedplugin', 'install_date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 1, 31, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Plugin.display_name'
        db.delete_column('storageadmin_plugin', 'display_name')

        # Deleting field 'Plugin.description'
        db.delete_column('storageadmin_plugin', 'description')

        # Adding unique constraint on 'Plugin', fields ['js_file_name']
        db.create_unique('storageadmin_plugin', ['js_file_name'])

        # Adding unique constraint on 'Plugin', fields ['css_file_name']
        db.create_unique('storageadmin_plugin', ['css_file_name'])

        # Deleting field 'InstalledPlugin.install_date'
        db.delete_column('storageadmin_installedplugin', 'install_date')
