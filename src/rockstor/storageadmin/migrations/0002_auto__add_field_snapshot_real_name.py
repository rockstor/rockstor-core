...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Snapshot.real_name'
        db.add_column('storageadmin_snapshot', 'real_name',
                      self.gf('django.db.models.fields.CharField')(default='unknownsnap', max_length=4096),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Snapshot.real_name'
        db.delete_column('storageadmin_snapshot', 'real_name')
