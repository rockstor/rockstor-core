...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'storageadmin_disk', 'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=128))

    def backwards(self, orm):

        # Changing field 'Disk.name'
        db.alter_column(u'storageadmin_disk', 'name', self.gf('django.db.models.fields.CharField')(max_length=64, unique=True))
    ...
    models = {
        ...
        u'oauth2_provider.application': {
            ...
            'client_id': ('django.db.models.fields.CharField', [], {'default': "u'wvSR3h3w7nDm1QH6KbbivpAKXyWxfMUHKdQERi9l'", 'unique': 'True', 'max_length': '100', 'db_index': 'True'}),
            'client_secret': ('django.db.models.fields.CharField', [], {'default': "u'kIJ7Y7mInCvm1kfMiWfgWtGuM90cuZ8AU7TCqHtDrHEm2QlckOKhCkcrtEswhdra57ibhBlwQNuLCHYjDXFQd7pNBcHcYqX6wTkOie4eA3avhjBdmvD55tb9QLlpRsec'", 'max_length': '255', 'db_index': 'True', 'blank': 'True'}),
        ...
        'storageadmin.pincard': {
            'Meta': {'unique_together': "(('user', 'pin_number'),)", 'object_name': 'Pincard'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
