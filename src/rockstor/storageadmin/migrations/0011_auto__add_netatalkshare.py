...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'NetatalkShare'
        db.create_table(u'storageadmin_netatalkshare', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('share', self.gf('django.db.models.fields.related.OneToOneField')(related_name='netatalkshare', unique=True, to=orm['storageadmin.Share'])),
            ('path', self.gf('django.db.models.fields.CharField')(unique=True, max_length=4096)),
            ('description', self.gf('django.db.models.fields.CharField')(default='afp on rockstor', max_length=1024)),
            ('time_machine', self.gf('django.db.models.fields.CharField')(default='yes', max_length=3)),
        ))
        db.send_create_signal('storageadmin', ['NetatalkShare'])


    def backwards(self, orm):
        # Deleting model 'NetatalkShare'
        db.delete_table(u'storageadmin_netatalkshare')
    ...
    models = {
        ...
        u'oauth2_provider.application': {
            ...
            'client_id': ('django.db.models.fields.CharField', [], {'default': "u';C98;RFcXAP.o0!TuB8Sn?mEz9bQQYhf4g.4LaWy'", 'unique': 'True', 'max_length': '100'}),
            'client_secret': ('django.db.models.fields.CharField', [], {'default': "u'Ws9FZkPJFHahpZHvCFveDGomAhQz2kzdFzzuYpU@Z6dy44gtnRj_n;=Qtr02a:JK2:b5LQf@KmqcLhTBJTHIEOm1-W=WcF=slOe7Hyy8vss9Cj6..szJ!RvrNoEO?Lhf'", 'max_length': '255', 'blank': 'True'}),
