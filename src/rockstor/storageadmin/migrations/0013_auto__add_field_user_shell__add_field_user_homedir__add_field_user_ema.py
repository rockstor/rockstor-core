...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.shell'
        db.add_column(u'storageadmin_user', 'shell',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True),
                      keep_default=False)

        # Adding field 'User.homedir'
        db.add_column(u'storageadmin_user', 'homedir',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True),
                      keep_default=False)

        # Adding field 'User.email'
        db.add_column(u'storageadmin_user', 'email',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True),
                      keep_default=False)

        # Adding field 'User.admin'
        db.add_column(u'storageadmin_user', 'admin',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.shell'
        db.delete_column(u'storageadmin_user', 'shell')

        # Deleting field 'User.homedir'
        db.delete_column(u'storageadmin_user', 'homedir')

        # Deleting field 'User.email'
        db.delete_column(u'storageadmin_user', 'email')

        # Deleting field 'User.admin'
        db.delete_column(u'storageadmin_user', 'admin')
    ...
    models = {
        ...
        u'oauth2_provider.application': {
            ...
            'client_id': ('django.db.models.fields.CharField', [], {'default': "u'tmEvr1!?K?AB3rwEQntR-2O.9ZSOTQ7QDKUt1jj;'", 'unique': 'True', 'max_length': '100'}),
            'client_secret': ('django.db.models.fields.CharField', [], {'default': "u'ac-LlE6_m5FiWF2lc3bjirf:YL.CJDSxxwN4!zT.jTzA4M7;X5aIPCbcC@jVILu@K!Oo==g2KnqM9zLzeq:LMFxhlhDPwa0;0i.6@:g=1kHvG1Hmz2mVmZOXyBJB9z6w'", 'max_length': '255', 'blank': 'True'}),
