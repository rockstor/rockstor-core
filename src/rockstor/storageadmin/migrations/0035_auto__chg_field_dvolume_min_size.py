...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DVolume.min_size'
        db.alter_column(u'storageadmin_dvolume', 'min_size', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'DVolume.min_size'
        db.alter_column(u'storageadmin_dvolume', 'min_size', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        u'oauth2_provider.application': {
            ...
            'client_id': ('django.db.models.fields.CharField', [], {'default': "u'sN0naaeySKET5iqxHO05;8JzlRnqc5gqU5y=8k?!'", 'unique': 'True', 'max_length': '100'}),
            'client_secret': ('django.db.models.fields.CharField', [], {'default': "u'GBekbAhBLHrjObXtL@KBys@TOrae2Gh1;nb.rO1pZc1wf70Q5;VZ=bhcfTpCYOt@K7v-GXU6O9pZ8ARfYyygqMR@86mElcl7s0VcIeV;LDIlvf-m0X57ALuSab9YcGRa'", 'max_length': '255', 'blank': 'True'}),
