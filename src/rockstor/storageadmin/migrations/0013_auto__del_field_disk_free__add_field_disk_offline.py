...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Disk.free'
        db.delete_column('storageadmin_disk', 'free')

        # Adding field 'Disk.offline'
        db.add_column('storageadmin_disk', 'offline',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Disk.free'
        db.add_column('storageadmin_disk', 'free',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Disk.offline'
        db.delete_column('storageadmin_disk', 'offline')
