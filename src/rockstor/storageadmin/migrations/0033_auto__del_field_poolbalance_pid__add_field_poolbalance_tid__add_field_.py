...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PoolBalance.pid'
        db.delete_column(u'storageadmin_poolbalance', 'pid')

        # Adding field 'PoolBalance.tid'
        db.add_column(u'storageadmin_poolbalance', 'tid',
                      self.gf('django.db.models.fields.CharField')(max_length=36, null=True),
                      keep_default=False)

        # Adding field 'PoolBalance.message'
        db.add_column(u'storageadmin_poolbalance', 'message',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'PoolBalance.pid'
        db.add_column(u'storageadmin_poolbalance', 'pid',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'PoolBalance.tid'
        db.delete_column(u'storageadmin_poolbalance', 'tid')

        # Deleting field 'PoolBalance.message'
        db.delete_column(u'storageadmin_poolbalance', 'message')
    ...
    models = {
        ...
        u'oauth2_provider.application': {
            ...
            'client_id': ('django.db.models.fields.CharField', [], {'default': "u'ganV_U1l88L4!B9Kbt586WlEqLV5zhWshA@rMY4?'", 'unique': 'True', 'max_length': '100'}),
            'client_secret': ('django.db.models.fields.CharField', [], {'default': "u'ghdz5VyrL15ebIB6s7Z9OmCK:RdBdqg-?PlZHS8I;ul4;yAC1ghULjRr6Gxgl128xANjejwhvpT0DS;XO0WXa!R3G;tQU4r9SdRm_ti_yqiIM6e8GO3FEeGHV5YNh?7o'", 'max_length': '255', 'blank': 'True'}),
