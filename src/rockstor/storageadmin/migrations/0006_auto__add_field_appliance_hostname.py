...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Appliance.hostname'
        db.add_column('storageadmin_appliance', 'hostname',
                      self.gf('django.db.models.fields.CharField')(default='Rockstor', max_length=128),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Appliance.hostname'
        db.delete_column('storageadmin_appliance', 'hostname')
