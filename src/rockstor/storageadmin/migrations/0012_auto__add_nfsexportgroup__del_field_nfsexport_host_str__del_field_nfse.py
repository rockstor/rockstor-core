...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'NFSExport.host_str'
        db.delete_column('storageadmin_nfsexport', 'host_str')

        # Deleting field 'NFSExport.syncable'
        db.delete_column('storageadmin_nfsexport', 'syncable')

        # Deleting field 'NFSExport.mount_security'
        db.delete_column('storageadmin_nfsexport', 'mount_security')

        # Deleting field 'NFSExport.enabled'
        db.delete_column('storageadmin_nfsexport', 'enabled')

        # Deleting field 'NFSExport.editable'
        db.delete_column('storageadmin_nfsexport', 'editable')

        # Deleting field 'NFSExport.nohide'
        db.delete_column('storageadmin_nfsexport', 'nohide')

        # Adding field 'NFSExport.export_group'
        db.add_column('storageadmin_nfsexport', 'export_group',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['storageadmin.NFSExportGroup']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'NFSExport.host_str'
        db.add_column('storageadmin_nfsexport', 'host_str',
                      self.gf('django.db.models.fields.CharField')(default='*', max_length=4096),
                      keep_default=False)

        # Adding field 'NFSExport.syncable'
        db.add_column('storageadmin_nfsexport', 'syncable',
                      self.gf('django.db.models.fields.CharField')(default='async', max_length=5),
                      keep_default=False)

        # Adding field 'NFSExport.mount_security'
        db.add_column('storageadmin_nfsexport', 'mount_security',
                      self.gf('django.db.models.fields.CharField')(default='insecure', max_length=8),
                      keep_default=False)

        # Adding field 'NFSExport.enabled'
        db.add_column('storageadmin_nfsexport', 'enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'NFSExport.editable'
        db.add_column('storageadmin_nfsexport', 'editable',
                      self.gf('django.db.models.fields.CharField')(default='ro', max_length=2),
                      keep_default=False)

        # Adding field 'NFSExport.nohide'
        db.add_column('storageadmin_nfsexport', 'nohide',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'NFSExport.export_group'
        db.delete_column('storageadmin_nfsexport', 'export_group_id')
