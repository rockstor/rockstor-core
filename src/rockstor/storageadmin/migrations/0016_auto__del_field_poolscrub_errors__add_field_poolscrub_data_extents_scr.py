...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PoolScrub.errors'
        db.delete_column(u'storageadmin_poolscrub', 'errors')

        # Adding field 'PoolScrub.data_extents_scrubbed'
        db.add_column(u'storageadmin_poolscrub', 'data_extents_scrubbed',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'PoolScrub.tree_extents_scrubbed'
        db.add_column(u'storageadmin_poolscrub', 'tree_extents_scrubbed',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'PoolScrub.tree_bytes_scrubbed'
        db.add_column(u'storageadmin_poolscrub', 'tree_bytes_scrubbed',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'PoolScrub.read_errors'
        db.add_column(u'storageadmin_poolscrub', 'read_errors',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'PoolScrub.csum_errors'
        db.add_column(u'storageadmin_poolscrub', 'csum_errors',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'PoolScrub.verify_errors'
        db.add_column(u'storageadmin_poolscrub', 'verify_errors',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'PoolScrub.no_csum'
        db.add_column(u'storageadmin_poolscrub', 'no_csum',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'PoolScrub.csum_discards'
        db.add_column(u'storageadmin_poolscrub', 'csum_discards',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'PoolScrub.super_errors'
        db.add_column(u'storageadmin_poolscrub', 'super_errors',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'PoolScrub.malloc_errors'
        db.add_column(u'storageadmin_poolscrub', 'malloc_errors',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'PoolScrub.uncorrectable_errors'
        db.add_column(u'storageadmin_poolscrub', 'uncorrectable_errors',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'PoolScrub.unverified_errors'
        db.add_column(u'storageadmin_poolscrub', 'unverified_errors',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'PoolScrub.corrected_errors'
        db.add_column(u'storageadmin_poolscrub', 'corrected_errors',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'PoolScrub.last_physical'
        db.add_column(u'storageadmin_poolscrub', 'last_physical',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'PoolScrub.errors'
        db.add_column(u'storageadmin_poolscrub', 'errors',
                      self.gf('django.db.models.fields.BigIntegerField')(null=True),
                      keep_default=False)

        # Deleting field 'PoolScrub.data_extents_scrubbed'
        db.delete_column(u'storageadmin_poolscrub', 'data_extents_scrubbed')

        # Deleting field 'PoolScrub.tree_extents_scrubbed'
        db.delete_column(u'storageadmin_poolscrub', 'tree_extents_scrubbed')

        # Deleting field 'PoolScrub.tree_bytes_scrubbed'
        db.delete_column(u'storageadmin_poolscrub', 'tree_bytes_scrubbed')

        # Deleting field 'PoolScrub.read_errors'
        db.delete_column(u'storageadmin_poolscrub', 'read_errors')

        # Deleting field 'PoolScrub.csum_errors'
        db.delete_column(u'storageadmin_poolscrub', 'csum_errors')

        # Deleting field 'PoolScrub.verify_errors'
        db.delete_column(u'storageadmin_poolscrub', 'verify_errors')

        # Deleting field 'PoolScrub.no_csum'
        db.delete_column(u'storageadmin_poolscrub', 'no_csum')

        # Deleting field 'PoolScrub.csum_discards'
        db.delete_column(u'storageadmin_poolscrub', 'csum_discards')

        # Deleting field 'PoolScrub.super_errors'
        db.delete_column(u'storageadmin_poolscrub', 'super_errors')

        # Deleting field 'PoolScrub.malloc_errors'
        db.delete_column(u'storageadmin_poolscrub', 'malloc_errors')

        # Deleting field 'PoolScrub.uncorrectable_errors'
        db.delete_column(u'storageadmin_poolscrub', 'uncorrectable_errors')

        # Deleting field 'PoolScrub.unverified_errors'
        db.delete_column(u'storageadmin_poolscrub', 'unverified_errors')

        # Deleting field 'PoolScrub.corrected_errors'
        db.delete_column(u'storageadmin_poolscrub', 'corrected_errors')

        # Deleting field 'PoolScrub.last_physical'
        db.delete_column(u'storageadmin_poolscrub', 'last_physical')
    ...
    models = {
        ...
        u'oauth2_provider.application': {
            ...
            'client_id': ('django.db.models.fields.CharField', [], {'default': "u'RwGmI;a.@c1KcBG.rCBkVz=h?NI!8GBxaTN.55nU'", 'unique': 'True', 'max_length': '100'}),
            'client_secret': ('django.db.models.fields.CharField', [], {'default': "u'S.xQ!ZdnM::P47HQ4f2E=rFrVyW;DozdRIK58S6wy@rr9Y_GxUbDL3=ewij9D9?dh7GWkIB;MH636ReCZ5HXGTOobrRy;EUNeO=Tyvk4eVUm495;@J!hZ06ApoCB0yn='", 'max_length': '255', 'blank': 'True'}),
