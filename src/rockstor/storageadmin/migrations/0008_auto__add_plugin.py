...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Plugin'
        db.create_table('storageadmin_plugin', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=4096)),
            ('css_file_name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=4096)),
            ('js_file_name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=4096)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table('storageadmin_plugin')
    ...
    models = {
        ...
        'storageadmin.plugin': {
            ...
            'css_file_name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '4096'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'js_file_name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '4096'}),
