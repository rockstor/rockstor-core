...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'storageadmin_sambashare', 'snapshot_prefix',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SambaShare.shadow_copy'
        db.delete_column(u'storageadmin_sambashare', 'shadow_copy')

        # Deleting field 'SambaShare.snapshot_prefix'
        db.delete_column(u'storageadmin_sambashare', 'snapshot_prefix')
    ...
    models = {
        ...
        u'oauth2_provider.application': {
            ...
            'client_id': ('django.db.models.fields.CharField', [], {'default': "u'2HjiA@;GksnobxVCP0LD2bYIf?9i9TEPm=3CQvcN'", 'unique': 'True', 'max_length': '100'}),
            'client_secret': ('django.db.models.fields.CharField', [], {'default': "u'9nX:O0?Oz3gFjJy8V15f5q?1qOq0;2.RVA?7dm@?8;mHKoahPi==HvI6dzq?5PB5oBheBspFExM_sB=;Orah!7QL4xIZ1Jk8phpQUO0QaMVai;5Te9G@VL_:x1qvoLYe'", 'max_length': '255', 'blank': 'True'}),
