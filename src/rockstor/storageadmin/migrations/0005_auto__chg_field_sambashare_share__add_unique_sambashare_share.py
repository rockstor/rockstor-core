...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SambaShare.share'
        db.alter_column('storageadmin_sambashare', 'share_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['storageadmin.Share']))
        # Adding unique constraint on 'SambaShare', fields ['share']
        db.create_unique('storageadmin_sambashare', ['share_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'SambaShare', fields ['share']
        db.delete_unique('storageadmin_sambashare', ['share_id'])


        # Changing field 'SambaShare.share'
        db.alter_column('storageadmin_sambashare', 'share_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['storageadmin.Share']))
