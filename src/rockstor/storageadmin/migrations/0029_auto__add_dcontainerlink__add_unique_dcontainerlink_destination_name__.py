...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DContainerLink'
        db.create_table(u'storageadmin_dcontainerlink', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('source', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['storageadmin.DContainer'], unique=True)),
            ('destination', self.gf('django.db.models.fields.related.ForeignKey')(related_name='destination_container', to=orm['storageadmin.DContainer'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=64, null=True)),
        ))
        db.send_create_signal('storageadmin', ['DContainerLink'])

        # Adding unique constraint on 'DContainerLink', fields ['destination', 'name']
        db.create_unique(u'storageadmin_dcontainerlink', ['destination_id', 'name'])

        # Adding field 'DVolume.description'
        db.add_column(u'storageadmin_dvolume', 'description',
        ...
        db.add_column(u'storageadmin_dvolume', 'label',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True),
                      keep_default=False)

        # Adding field 'DPort.description'
        db.add_column(u'storageadmin_dport', 'description',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True),
                      keep_default=False)
        ...
        db.add_column(u'storageadmin_rockon', 'https',
        ...
        db.delete_column(u'storageadmin_dcontainer', 'link_id')

        # Adding field 'DContainer.launch_order'
        db.add_column(u'storageadmin_dcontainer', 'launch_order',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'DCustomConfig.label'
        db.add_column(u'storageadmin_dcustomconfig', 'label',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'DContainerLink', fields ['destination', 'name']
        db.delete_unique(u'storageadmin_dcontainerlink', ['destination_id', 'name'])

        # Deleting model 'DContainerLink'
        db.delete_table(u'storageadmin_dcontainerlink')

        # Deleting field 'DVolume.description'
        db.delete_column(u'storageadmin_dvolume', 'description')

        # Deleting field 'DVolume.min_size'
        db.delete_column(u'storageadmin_dvolume', 'min_size')

        # Deleting field 'DVolume.label'
        db.delete_column(u'storageadmin_dvolume', 'label')
        ...
        db.add_column(u'storageadmin_dcontainer', 'link',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['storageadmin.DContainer'], null=True),
                      keep_default=False)

        # Deleting field 'DContainer.launch_order'
        db.delete_column(u'storageadmin_dcontainer', 'launch_order')

        # Deleting field 'DCustomConfig.label'
        db.delete_column(u'storageadmin_dcustomconfig', 'label')
