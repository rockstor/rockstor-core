...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CustomConfig'
        db.create_table(u'storageadmin_customconfig', (
        ...
        db.send_create_signal('storageadmin', ['CustomConfig'])


    def backwards(self, orm):
        # Deleting model 'CustomConfig'
        db.delete_table(u'storageadmin_customconfig')
    ...
    models = {
        ...
        u'oauth2_provider.application': {
            ...
            'client_id': ('django.db.models.fields.CharField', [], {'default': "u'3WIMiQMk?Trs14a9BHwB9BfBau@UD!FXGt14=OtZ'", 'unique': 'True', 'max_length': '100'}),
            'client_secret': ('django.db.models.fields.CharField', [], {'default': "u'2CW0;CO07kF:7uBCpleVXiB.v==O;BDeHK!pTLDM:3SpPIv8--9oICLQooWCsA8sWMKwqW5zV1kentC1n;f-KZchP5fuBJfWeZc?wG5Clnb=0xqWSa2:-VZ!=i4Pf_n3'", 'max_length': '255', 'blank': 'True'}),
        ...
        'storageadmin.customconfig': {
            'Meta': {'object_name': 'CustomConfig'},
