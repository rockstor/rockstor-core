...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.public_key'
        db.add_column(u'storageadmin_user', 'public_key',
                      self.gf('django.db.models.fields.CharField')(max_length=4096, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.public_key'
        db.delete_column(u'storageadmin_user', 'public_key')
    ...
    models = {
        ...
        u'oauth2_provider.application': {
            ...
            'client_id': ('django.db.models.fields.CharField', [], {'default': "u'xh2otKofTCXPZW7np4r0bmzumbHuhwmDc5@.yGwb'", 'unique': 'True', 'max_length': '100'}),
            'client_secret': ('django.db.models.fields.CharField', [], {'default': "u'4Efg6:39fK5@uqXu.nolB8ZAcpcOkk93oFhip8gIWV=m@F3DTJyI!:W09jup1BdgmyRIKIiR6xLM2eDjZyrbEOwh59KH-2IP!Iz.ksDIfuwiJ1ne7qujeAEtBIUIw5Ja'", 'max_length': '255', 'blank': 'True'}),
