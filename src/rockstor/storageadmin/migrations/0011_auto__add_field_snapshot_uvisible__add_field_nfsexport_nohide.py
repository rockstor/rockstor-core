...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Snapshot.uvisible'
        db.add_column('storageadmin_snapshot', 'uvisible',
    ...
    def backwards(self, orm):
        # Deleting field 'Snapshot.uvisible'
        db.delete_column('storageadmin_snapshot', 'uvisible')
