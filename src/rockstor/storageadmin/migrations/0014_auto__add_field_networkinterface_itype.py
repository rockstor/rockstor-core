...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NetworkInterface.itype'
        db.add_column('storageadmin_networkinterface', 'itype',
                      self.gf('django.db.models.fields.CharField')(default='management', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NetworkInterface.itype'
        db.delete_column('storageadmin_networkinterface', 'itype')
    ...
    models = {
        ...
        'storageadmin.networkinterface': {
            ...
            'itype': ('django.db.models.fields.CharField', [], {'default': "'management'", 'max_length': '100'}),
