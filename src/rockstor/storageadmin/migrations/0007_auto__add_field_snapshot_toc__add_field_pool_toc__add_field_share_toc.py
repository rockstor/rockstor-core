...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Snapshot.toc'
        db.add_column('storageadmin_snapshot', 'toc',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 8, 14, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Pool.toc'
        db.add_column('storageadmin_pool', 'toc',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 8, 14, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Share.toc'
        db.add_column('storageadmin_share', 'toc',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 8, 14, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Snapshot.toc'
        db.delete_column('storageadmin_snapshot', 'toc')

        # Deleting field 'Pool.toc'
        db.delete_column('storageadmin_pool', 'toc')

        # Deleting field 'Share.toc'
        db.delete_column('storageadmin_share', 'toc')
