...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Port'
        db.create_table(u'storageadmin_port', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('storageadmin', ['Port'])

        # Adding unique constraint on 'Port', fields ['container', 'containerp']
        db.create_unique(u'storageadmin_port', ['container_id', 'containerp'])
        ...
        # Adding model 'Volume'
        db.create_table(u'storageadmin_volume', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('container', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['storageadmin.DContainer'])),
        ...
        db.send_create_signal('storageadmin', ['Volume'])

        # Adding unique constraint on 'Volume', fields ['container', 'dest_dir']
        db.create_unique(u'storageadmin_volume', ['container_id', 'dest_dir'])


    def backwards(self, orm):
        # Removing unique constraint on 'Volume', fields ['container', 'dest_dir']
        db.delete_unique(u'storageadmin_volume', ['container_id', 'dest_dir'])

        # Removing unique constraint on 'Port', fields ['container', 'containerp']
        db.delete_unique(u'storageadmin_port', ['container_id', 'containerp'])

        # Deleting model 'ContainerOption'
        db.delete_table(u'storageadmin_containeroption')

        # Deleting model 'Port'
        db.delete_table(u'storageadmin_port')
        ...
        db.delete_table(u'storageadmin_volume')
    ...
    models = {
        ...
        u'oauth2_provider.application': {
            ...
            'client_id': ('django.db.models.fields.CharField', [], {'default': "u'-GTL!Pa0_mI.N0OC=26.nP@kOdNQwN=zH5qx@EBM'", 'unique': 'True', 'max_length': '100'}),
            'client_secret': ('django.db.models.fields.CharField', [], {'default': "u'ZDq1_NNVGUi_vWNm?DfXqgl3.rRKCAG=ncMcy8F78e=3cWT2YkQlWc:7vsO6n0ZSI.cLQJn7faOC.1xDW9hhIh3xD=gJWmY3Z4M@PY-2qM3pvu7wA@e@dFXe4QA:;B??'", 'max_length': '255', 'blank': 'True'}),
