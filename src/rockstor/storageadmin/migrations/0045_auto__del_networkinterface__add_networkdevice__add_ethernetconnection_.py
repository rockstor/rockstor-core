...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'storageadmin_networkdevice', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=256)),
            ('dtype', self.gf('django.db.models.fields.CharField')(max_length=100, null=True)),
            ('mac', self.gf('django.db.models.fields.CharField')(max_length=100, null=True)),
            ('connection', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['storageadmin.NetworkConnection'], null=True, on_delete=models.SET_NULL)),
            ('state', self.gf('django.db.models.fields.CharField')(max_length=64, null=True)),
            ('mtu', self.gf('django.db.models.fields.CharField')(max_length=64, null=True)),
        ))
        db.send_create_signal('storageadmin', ['NetworkDevice'])

        # Adding model 'EthernetConnection'
        db.create_table(u'storageadmin_ethernetconnection', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('connection', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['storageadmin.NetworkConnection'], null=True)),
            ('mac', self.gf('django.db.models.fields.CharField')(max_length=64, null=True)),
            ('cloned_mac', self.gf('django.db.models.fields.CharField')(max_length=64, null=True)),
            ('mtu', self.gf('django.db.models.fields.CharField')(max_length=64, null=True)),
        ))
        db.send_create_signal('storageadmin', ['EthernetConnection'])

        # Adding model 'BondConnection'
        db.create_table(u'storageadmin_bondconnection', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('connection', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['storageadmin.NetworkConnection'], null=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=64, null=True)),
            ('config', self.gf('django.db.models.fields.CharField')(max_length=2048, null=True)),
        ))
        db.send_create_signal('storageadmin', ['BondConnection'])

        # Adding model 'TeamConnection'
        db.create_table(u'storageadmin_teamconnection', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('connection', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['storageadmin.NetworkConnection'], null=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=64, null=True)),
            ('config', self.gf('django.db.models.fields.CharField')(max_length=2048, null=True)),
        ))
        db.send_create_signal('storageadmin', ['TeamConnection'])

        # Adding model 'NetworkConnection'
        db.create_table(u'storageadmin_networkconnection', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=256, null=True)),
            ('uuid', self.gf('django.db.models.fields.CharField')(unique=True, max_length=256)),
            ('state', self.gf('django.db.models.fields.CharField')(max_length=64, null=True)),
            ('autoconnect', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('ipv4_method', self.gf('django.db.models.fields.CharField')(max_length=64, null=True)),
            ('ipv4_addresses', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True)),
            ('ipv4_gw', self.gf('django.db.models.fields.CharField')(max_length=64, null=True)),
            ('ipv4_dns', self.gf('django.db.models.fields.CharField')(max_length=256, null=True)),
            ('ipv4_dns_search', self.gf('django.db.models.fields.CharField')(max_length=256, null=True)),
            ('ipv6_method', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True)),
            ('ipv6_addresses', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True)),
            ('ipv6_gw', self.gf('django.db.models.fields.CharField')(max_length=64, null=True)),
            ('ipv6_dns', self.gf('django.db.models.fields.CharField')(max_length=256, null=True)),
            ('ipv6_dns_search', self.gf('django.db.models.fields.CharField')(max_length=256, null=True)),
            ('master', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['storageadmin.NetworkConnection'], null=True)),
        ))
        db.send_create_signal('storageadmin', ['NetworkConnection'])


    def backwards(self, orm):
        # Adding model 'NetworkInterface'
        db.create_table(u'storageadmin_networkinterface', (
            ('autoconnect', self.gf('django.db.models.fields.CharField')(max_length=8, null=True)),
            ('dns_servers', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True)),
            ...
            ('state', self.gf('django.db.models.fields.CharField')(max_length=64, null=True)),
            ('dname', self.gf('django.db.models.fields.CharField')(max_length=100, null=True)),
            ('dtype', self.gf('django.db.models.fields.CharField')(max_length=64, null=True)),
            ('dspeed', self.gf('django.db.models.fields.CharField')(max_length=64, null=True)),
            ('ipaddr', self.gf('django.db.models.fields.CharField')(max_length=64, null=True)),
            ('netmask', self.gf('django.db.models.fields.CharField')(max_length=64, null=True)),
            ('ctype', self.gf('django.db.models.fields.CharField')(max_length=64, null=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('method', self.gf('django.db.models.fields.CharField')(max_length=64, null=True)),
            ('mac', self.gf('django.db.models.fields.CharField')(max_length=100, null=True)),
        ...
        db.delete_table(u'storageadmin_networkdevice')

        # Deleting model 'EthernetConnection'
        db.delete_table(u'storageadmin_ethernetconnection')

        # Deleting model 'BondConnection'
        db.delete_table(u'storageadmin_bondconnection')

        # Deleting model 'TeamConnection'
        db.delete_table(u'storageadmin_teamconnection')

        # Deleting model 'NetworkConnection'
        db.delete_table(u'storageadmin_networkconnection')
    ...
    models = {
        ...
        u'oauth2_provider.application': {
            ...
            'client_id': ('django.db.models.fields.CharField', [], {'default': "u'sZgOY9XFnykqLZ0vluBApVOM3lVecbNIxKSejLxd'", 'unique': 'True', 'max_length': '100', 'db_index': 'True'}),
            'client_secret': ('django.db.models.fields.CharField', [], {'default': "u'bdHHoQwmKJvHxnm8gBDd7Ad4fNqqAojoMg8rRBiIGAQC5TCsgIYYtszIJX9F5px2jSfDUGSoBoATZ4M5NivkvGdYScDlWtFupLahDcp2c9oHOTvQfvT2EpxlLslQkqyb'", 'max_length': '255', 'db_index': 'True', 'blank': 'True'}),
        ...
        'storageadmin.bondconnection': {
            'Meta': {'object_name': 'BondConnection'},
            'config': ('django.db.models.fields.CharField', [], {'max_length': '2048', 'null': 'True'}),
            'connection': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['storageadmin.NetworkConnection']", 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'storageadmin.ethernetconnection': {
            'Meta': {'object_name': 'EthernetConnection'},
            'cloned_mac': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True'}),
            'connection': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['storageadmin.NetworkConnection']", 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mac': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True'}),
            'mtu': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True'})
        },
        'storageadmin.group': {
            'Meta': {'object_name': 'Group'},
        ...
        'storageadmin.networkconnection': {
            'Meta': {'object_name': 'NetworkConnection'},
            'autoconnect': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ipv4_addresses': ('django.db.models.fields.CharField', [], {'max_length': '1024', 'null': 'True'}),
            'ipv4_dns': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True'}),
            'ipv4_dns_search': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True'}),
            'ipv4_gw': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True'}),
            'ipv4_method': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True'}),
            'ipv6_addresses': ('django.db.models.fields.CharField', [], {'max_length': '1024', 'null': 'True'}),
            'ipv6_dns': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True'}),
            'ipv6_dns_search': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True'}),
            'ipv6_gw': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True'}),
            'ipv6_method': ('django.db.models.fields.CharField', [], {'max_length': '1024', 'null': 'True'}),
            'master': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['storageadmin.NetworkConnection']", 'null': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True'}),
            'state': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '256'})
        },
        'storageadmin.networkdevice': {
            'Meta': {'object_name': 'NetworkDevice'},
            'connection': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['storageadmin.NetworkConnection']", 'null': 'True', 'on_delete': 'models.SET_NULL'}),
            'dtype': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'storageadmin.teamconnection': {
            'Meta': {'object_name': 'TeamConnection'},
            'config': ('django.db.models.fields.CharField', [], {'max_length': '2048', 'null': 'True'}),
            'connection': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['storageadmin.NetworkConnection']", 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True'})
