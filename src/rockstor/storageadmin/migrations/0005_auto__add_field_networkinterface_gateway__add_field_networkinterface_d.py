...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NetworkInterface.gateway'
        db.add_column(u'storageadmin_networkinterface', 'gateway',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True),
                      keep_default=False)

        # Adding field 'NetworkInterface.dns_servers'
        db.add_column(u'storageadmin_networkinterface', 'dns_servers',
    ...
    def backwards(self, orm):
        # Deleting field 'NetworkInterface.gateway'
        db.delete_column(u'storageadmin_networkinterface', 'gateway')

        # Deleting field 'NetworkInterface.dns_servers'
        db.delete_column(u'storageadmin_networkinterface', 'dns_servers')
