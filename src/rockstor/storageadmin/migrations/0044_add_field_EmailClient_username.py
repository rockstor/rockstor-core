...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EmailClient.username'
        db.add_column(u'storageadmin_emailclient', 'username',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1024),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EmailClient.username'
        db.delete_column(u'storageadmin_emailclient', 'username')
    ...
    models = {
        ...
        u'oauth2_provider.application': {
            ...
            'client_id': ('django.db.models.fields.CharField', [], {'default': "u'PvvkiP6dFFQhOtT7HVrviCMluniPCVauqpDgeCh3'", 'unique': 'True', 'max_length': '100', 'db_index': 'True'}),
            'client_secret': ('django.db.models.fields.CharField', [], {'default': "u'v8kzlIujBg3chJJQnvoPTXtobrCp6JcPpPJibtCdOOyfAmkVceDP3xkjXdeyh0jutmUWPRzITwqDjA81P2LyY9AUvtSjebHQQ2yrmHHtJmZ3ser6TCtJ5hkq0uyQQEpX'", 'max_length': '255', 'db_index': 'True', 'blank': 'True'}),
