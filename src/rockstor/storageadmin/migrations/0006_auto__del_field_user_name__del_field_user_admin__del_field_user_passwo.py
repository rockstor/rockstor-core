...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('storageadmin_user', 'name')

        # Deleting field 'User.admin'
        db.delete_column('storageadmin_user', 'admin')

        # Deleting field 'User.password'
        db.delete_column('storageadmin_user', 'password')

        # Adding field 'User.user'
        db.add_column('storageadmin_user', 'user',
                      self.gf('django.db.models.fields.related.OneToOneField')(related_name='suser', unique=True, null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'User.username'
        db.add_column('storageadmin_user', 'username',
    ...
    def backwards(self, orm):
        ...
        db.add_column('storageadmin_user', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=4096, unique=True),
                      keep_default=False)

        # Adding field 'User.admin'
        db.add_column('storageadmin_user', 'admin',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'User.password'
        db.add_column('storageadmin_user', 'password',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128),
                      keep_default=False)

        # Deleting field 'User.user'
        db.delete_column('storageadmin_user', 'user_id')

        # Deleting field 'User.username'
        db.delete_column('storageadmin_user', 'username')
