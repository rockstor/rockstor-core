...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Appliance.mgmt_port'
        db.add_column('storageadmin_appliance', 'mgmt_port',
                      self.gf('django.db.models.fields.IntegerField')(default=443),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Appliance.mgmt_port'
        db.delete_column('storageadmin_appliance', 'mgmt_port')
