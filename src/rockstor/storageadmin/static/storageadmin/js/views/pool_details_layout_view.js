...
PoolDetailsLayoutView = RockstorLayoutView.extend({
	...
	Handlebars.registerHelper('poolCompressionNone', function(compression,opts){
	    if (compression == 'no') {
	    	return opts.fn(this);
	    }
	...
	Handlebars.registerHelper('displayMtOptions', function(mtOptions,opts){
