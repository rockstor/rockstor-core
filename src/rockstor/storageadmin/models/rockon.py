...
class DContainer(models.Model):
    rockon = models.ForeignKey(RockOn, on_delete=models.DO_NOTHING)
    dimage = models.ForeignKey(DImage, on_delete=models.DO_NOTHING)
...
class DContainerLink(models.Model):
    source = models.OneToOneField(DContainer, on_delete=models.DO_NOTHING)
    destination = models.ForeignKey(DContainer, related_name="destination_container", on_delete=models.DO_NOTHING)
...
class DContainerNetwork(models.Model):
    container = models.ForeignKey(DContainer, on_delete=models.DO_NOTHING)
    connection = models.ForeignKey(BridgeConnection, on_delete=models.DO_NOTHING)
...
class DVolume(models.Model):
    container = models.ForeignKey(DContainer, on_delete=models.DO_NOTHING)
    share = models.ForeignKey(Share, null=True, on_delete=models.DO_NOTHING)
