...
class OauthAppTests(APITestMixin, APITestCase):
    ...
    def test_delete_requests(self):
        ...
        e_msg = ('application(cliapp) cannot be deleted because it is used internally by Rockstor. If you really need to delete it, login as root and use /opt/rock-dep/bin/delete-api-key command. If you do delete it, please create another one with the same name as it is required by Rockstor internally.')
        self.assertEqual(response.data['detail'], e_msg)
