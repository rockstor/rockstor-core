...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PoolUsage.usage'
        db.delete_column(u'smart_manager_poolusage', 'usage')

        # Adding field 'PoolUsage.free'
        db.add_column(u'smart_manager_poolusage', 'free',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'PoolUsage.reclaimable'
        db.add_column(u'smart_manager_poolusage', 'reclaimable',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'PoolUsage.usage'
        db.add_column(u'smart_manager_poolusage', 'usage',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'PoolUsage.free'
        db.delete_column(u'smart_manager_poolusage', 'free')

        # Deleting field 'PoolUsage.reclaimable'
        db.delete_column(u'smart_manager_poolusage', 'reclaimable')
