...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TaskDefinition.crontabwindow'
        db.add_column(u'smart_manager_taskdefinition', 'crontabwindow',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TaskDefinition.crontabwindow'
        db.delete_column(u'smart_manager_taskdefinition', 'crontabwindow')
    ...
    models = {
        ...
        'smart_manager.replica': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'meta_port': ('django.db.models.fields.IntegerField', [], {'default': '10002'}),
            'pool': ('django.db.models.fields.CharField', [], {'max_length': '4096'}),
        ...
        'smart_manager.taskdefinition': {
            ...
            'crontab': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True'}),
            'crontabwindow': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True'}),
