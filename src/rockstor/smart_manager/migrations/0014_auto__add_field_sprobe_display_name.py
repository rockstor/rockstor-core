...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SProbe.display_name'
        db.add_column('smart_manager_sprobe', 'display_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SProbe.display_name'
        db.delete_column('smart_manager_sprobe', 'display_name')
