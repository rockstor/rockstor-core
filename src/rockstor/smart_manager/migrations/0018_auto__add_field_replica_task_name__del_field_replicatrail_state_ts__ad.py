...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Replica.task_name'
        db.add_column('smart_manager_replica', 'task_name',
        ...
        # Adding field 'ReplicaTrail.kb_sent'
        db.add_column('smart_manager_replicatrail', 'kb_sent',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'ReplicaTrail.snapshot_created'
        db.add_column('smart_manager_replicatrail', 'snapshot_created',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'ReplicaTrail.snapshot_failed'
        db.add_column('smart_manager_replicatrail', 'snapshot_failed',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'ReplicaTrail.send_pending'
        db.add_column('smart_manager_replicatrail', 'send_pending',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'ReplicaTrail.send_succeeded'
        db.add_column('smart_manager_replicatrail', 'send_succeeded',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'ReplicaTrail.send_failed'
        db.add_column('smart_manager_replicatrail', 'send_failed',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'ReplicaTrail.end_ts'
        db.add_column('smart_manager_replicatrail', 'end_ts',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'ReplicaTrail.error'
        db.add_column('smart_manager_replicatrail', 'error',
                      self.gf('django.db.models.fields.CharField')(max_length=4096, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Replica.task_name'
        db.delete_column('smart_manager_replica', 'task_name')
        ...
        # Deleting field 'ReplicaTrail.kb_sent'
        db.delete_column('smart_manager_replicatrail', 'kb_sent')

        # Deleting field 'ReplicaTrail.snapshot_created'
        db.delete_column('smart_manager_replicatrail', 'snapshot_created')

        # Deleting field 'ReplicaTrail.snapshot_failed'
        db.delete_column('smart_manager_replicatrail', 'snapshot_failed')

        # Deleting field 'ReplicaTrail.send_pending'
        db.delete_column('smart_manager_replicatrail', 'send_pending')

        # Deleting field 'ReplicaTrail.send_succeeded'
        db.delete_column('smart_manager_replicatrail', 'send_succeeded')

        # Deleting field 'ReplicaTrail.send_failed'
        db.delete_column('smart_manager_replicatrail', 'send_failed')

        # Deleting field 'ReplicaTrail.end_ts'
        db.delete_column('smart_manager_replicatrail', 'end_ts')

        # Deleting field 'ReplicaTrail.error'
        db.delete_column('smart_manager_replicatrail', 'error')
