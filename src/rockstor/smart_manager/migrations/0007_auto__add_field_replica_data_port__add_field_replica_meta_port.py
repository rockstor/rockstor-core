...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Replica.data_port'
        db.add_column('smart_manager_replica', 'data_port',
                      self.gf('django.db.models.fields.IntegerField')(default=10002),
                      keep_default=False)

        # Adding field 'Replica.meta_port'
        db.add_column('smart_manager_replica', 'meta_port',
                      self.gf('django.db.models.fields.IntegerField')(default=10003),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Replica.data_port'
        db.delete_column('smart_manager_replica', 'data_port')

        # Deleting field 'Replica.meta_port'
        db.delete_column('smart_manager_replica', 'meta_port')
