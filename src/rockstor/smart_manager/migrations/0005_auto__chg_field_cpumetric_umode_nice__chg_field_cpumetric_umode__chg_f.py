...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CPUMetric.umode_nice'
        db.alter_column(u'smart_manager_cpumetric', 'umode_nice', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'CPUMetric.umode'
        db.alter_column(u'smart_manager_cpumetric', 'umode', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'CPUMetric.idle'
        db.alter_column(u'smart_manager_cpumetric', 'idle', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'CPUMetric.smode'
        db.alter_column(u'smart_manager_cpumetric', 'smode', self.gf('django.db.models.fields.FloatField')())

    def backwards(self, orm):

        # Changing field 'CPUMetric.umode_nice'
        db.alter_column(u'smart_manager_cpumetric', 'umode_nice', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'CPUMetric.umode'
        db.alter_column(u'smart_manager_cpumetric', 'umode', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'CPUMetric.idle'
        db.alter_column(u'smart_manager_cpumetric', 'idle', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'CPUMetric.smode'
        db.alter_column(u'smart_manager_cpumetric', 'smode', self.gf('django.db.models.fields.IntegerField')())

    models = {
        'smart_manager.cpumetric': {
            'Meta': {'object_name': 'CPUMetric'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'idle': ('django.db.models.fields.FloatField', [], {}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
            'smode': ('django.db.models.fields.FloatField', [], {}),
            'ts': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'db_index': 'True', 'blank': 'True'}),
            'umode': ('django.db.models.fields.FloatField', [], {}),
            'umode_nice': ('django.db.models.fields.FloatField', [], {})
        },
