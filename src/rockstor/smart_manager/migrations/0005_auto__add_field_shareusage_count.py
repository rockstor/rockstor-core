...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ShareUsage.count'
        db.add_column('smart_manager_shareusage', 'count',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ShareUsage.count'
        db.delete_column('smart_manager_shareusage', 'count')
