...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TaskDefinition.frequency'
        db.delete_column(u'smart_manager_taskdefinition', 'frequency')

        # Deleting field 'TaskDefinition.ts'
        db.delete_column(u'smart_manager_taskdefinition', 'ts')

        # Adding field 'TaskDefinition.crontab'
        db.add_column(u'smart_manager_taskdefinition', 'crontab',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'TaskDefinition.frequency'
        db.add_column(u'smart_manager_taskdefinition', 'frequency',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'TaskDefinition.ts'
        db.add_column(u'smart_manager_taskdefinition', 'ts',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 7, 29, 0, 0), db_index=True),
                      keep_default=False)

        # Deleting field 'TaskDefinition.crontab'
        db.delete_column(u'smart_manager_taskdefinition', 'crontab')
