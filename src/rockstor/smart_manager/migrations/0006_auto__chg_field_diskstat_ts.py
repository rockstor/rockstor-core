...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DiskStat.ts'
        db.alter_column('smart_manager_diskstat', 'ts', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'DiskStat.ts'
        db.alter_column('smart_manager_diskstat', 'ts', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
