...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Replica.frequency'
        db.delete_column(u'smart_manager_replica', 'frequency')

        # Adding field 'Replica.crontab'
        db.add_column(u'smart_manager_replica', 'crontab',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Replica.frequency'
        db.add_column(u'smart_manager_replica', 'frequency',
                      self.gf('django.db.models.fields.IntegerField')(default=10000),
                      keep_default=False)

        # Deleting field 'Replica.crontab'
        db.delete_column(u'smart_manager_replica', 'crontab')
