...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Service.registered'
        db.delete_column('smart_manager_service', 'registered')

        # Adding field 'Service.display_name'
        db.add_column('smart_manager_service', 'display_name',
                      self.gf('django.db.models.fields.CharField')(default=False, unique=True, max_length=24),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Service.registered'
        db.add_column('smart_manager_service', 'registered',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Service.display_name'
        db.delete_column('smart_manager_service', 'display_name')
