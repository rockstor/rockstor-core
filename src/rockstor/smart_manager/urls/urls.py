...
urlpatterns = patterns('',
    # Services
    url(r'^services/$', ServiceView.as_view(), name='service-view'),
    url(r'^services/(?P<sname>[A-Za-z_]+)/$', ServiceView.as_view(),
        name='service-view'),
    ...
    url(r'^sprobes/diskstat/$', DiskStatView.as_view(),
        name='diskstat-view'),
    url(r'^sprobes/meminfo/$', MemInfoView.as_view(),
        name='meminfo-view'),
    url(r'^sprobes/netstat/$', NetStatView.as_view(),
        name='netstat-view'),

    # Advanced smart probes
    url(r'^sprobes/nfs-distrib/$', NFSDistribView.as_view(), name='nfsdistrib-view'),
